...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/white-boat-f37b
```

A live public deployment of this template is available at [https://white-boat-f37b.templates.workers.dev](https://white-boat-f37b.templates.workers.dev)
